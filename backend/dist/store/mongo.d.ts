...
export declare function getCollectionById(id: string, teamId: string): Promise<Collection | undefined>;
...
export declare function getCollectionChildren(id: string, teamId: string, projectId?: string | null): Promise<Collection[]>;
export declare function getCollectionTree(id: string, teamId: string, maxDepth?: number): Promise<CollectionTreeNode | undefined>;
export declare function createTestCase(collectionId: string, teamId: string, dto: CreateTestCaseDto): Promise<TestCase | undefined>;
export declare function getTestCaseById(collectionId: string, testId: string, teamId: string): Promise<TestCase | undefined>;
export declare function updateTestCase(collectionId: string, testId: string, teamId: string, dto: UpdateTestCaseDto): Promise<TestCase | undefined>;
export declare function deleteTestCase(collectionId: string, testId: string, teamId: string): Promise<boolean>;
