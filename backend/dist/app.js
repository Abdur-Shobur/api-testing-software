...
const teamMemberRoutes_1 = require("./routes/teamMemberRoutes");
const teamInviteRoutes_1 = require("./routes/teamInviteRoutes");
...
exports.app.use('/teams', auth_1.requireAuth, teamRoutes_1.teamRouter);
exports.app.use('/team-members', auth_1.requireAuth, teamMemberRoutes_1.teamMemberRouter);
exports.app.use('/team-invites', auth_1.requireAuth, teamInviteRoutes_1.teamInviteRouter);
