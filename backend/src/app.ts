...
import { teamInviteRouter } from './routes/teamInviteRoutes';
...
app.use('/team-members', requireAuth, teamMemberRouter);
app.use('/team-invites', requireAuth, teamInviteRouter);
