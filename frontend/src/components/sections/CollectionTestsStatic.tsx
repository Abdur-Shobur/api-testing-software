...
export function CollectionTestsStatic() {
	...
	return (
		<div className="flex flex-col border-r border-zinc-800 w-72 shrink-0 h-screen bg-zinc-950">
			...
			<div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
				...
				<button className="h-8 px-3 rounded-lg bg-zinc-100 text-zinc-900 text-[12px] font-medium flex items-center gap-1 hover:opacity-90">
				...
				{collection.testCases.map((test) => (
					<div
						...
						onClick={() => {
							...
							router.push(`/view/projectId/collection/collectionID`);
						}}
						className={cn(
					...
					>
						...
						>
							...
							<IconBtn title="Delete" variant="danger">
